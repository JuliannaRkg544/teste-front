...
export default function Admin() {
    ...
    const URL_GET_ALL_USER = `https://scti-back-teste-production-3e0d.up.railway.app/user-all`
    const URL_RELEASE_USER = `https://scti-back-teste-production-3e0d.up.railway.app/user-release-access`
    const URL_DENY_USER = `https://scti-back-teste-production-3e0d.up.railway.app/user-deny-access`
